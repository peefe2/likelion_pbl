      ...
      <div className="options-container">
        <div className="filter-group">
          ...
          <select
            id="filter-part"
            value={filter}
            onChange={(e: ChangeEvent<HTMLSelectElement>) => updateParam('part', e.target.value, 'all')}
          >
        ...
        <div className="sort-group">
          ...
          <select
            id="sort-order"
            value={sort}
            onChange={(e: ChangeEvent<HTMLSelectElement>) => updateParam('sort', e.target.value, 'latest')}
          >
